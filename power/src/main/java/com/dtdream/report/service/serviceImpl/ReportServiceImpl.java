...
public class ReportServiceImpl implements ReportService{
    ...
    @Override
    public List<Report> queryListByParam(Map<String, Object> paramMap, Integer pageNum, Integer pageSize) {
        return reportMapper.queryListByParam(paramMap,pageNum,pageSize);
    }
}
